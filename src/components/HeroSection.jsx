  ...
  return (
    <section className="text-light bg-dark d-flex align-items-center position-relative " >
      <div className="container z-1">
        ...
        <p className="w-50 text-center mb-5 mx-auto fs-5 fs-lg-4">
        ...
        <div className="d-flex justify-content-center gap-3">
          <motion.a 
            ...
            href='https://t.me/taylorwifjetmeme'
             target='_blank' 
             className='btn btn-outline-danger btn-lg rounded-5 fs-5 fs-md-4 fw-bold border-3 shadow px-4 py-3'
             >
              JOIN OUR COMMUNITY 
      ...
      >
        <img src={jetImage} className="img-fluid z-0 opacity-25" alt="jet" />
      </div>
    </section>
  );
};
